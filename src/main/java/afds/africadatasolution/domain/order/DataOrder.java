...
/** Mirrors the Prisma {@code DataOrder} model. */
@Entity
...
public class DataOrder {
    ...
    @Column(name = "sme_plug_response", columnDefinition = "jsonb")
    private Map<String, Object> smePlugResponse = new HashMap<>();
